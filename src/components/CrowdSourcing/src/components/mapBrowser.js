            ...
            <Grid.Column>
              {this.state.updatedData ? (
                <div>
                  <Segment>
                    <Label attached="top">
                      Click on a country to view its projects, or change themes
                      below
                    </Label>
                    <ChoroplethMap
                      toggleDropdownUpdated={this.toggleDropdownUpdated}
                      dropdownUpdated={this.state.dropdownUpdated}
                      history={this.props.history}
                      handleClick={this.goToProjects}
              ...
              <div>
                ...
                {this.state.updatedMapThemes ? (
                  <ThemesDropdownMultiple
                    updateMapThemes={this.updateMapThemes}
                    themes={this.props.themes}
                    mapThemes={this.state.mapThemes}
